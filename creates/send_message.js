...
module.exports = {
  ...
  display: {
    label: 'Send Message',
    description: 'Creates a WhatsApp message and delivers it to a single recipient.',
  },
  operation: {
    inputFields: [
      deviceField(),
      ...
      },
      {
        ...
        required: false,
        helpText:
          'Shows the typing indicator on the device before the message is delivered. Kirimi enables this by default.',
      },
      {
        key: 'typing_speed_ms',
